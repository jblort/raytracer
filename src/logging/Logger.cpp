...
void Logger::logVector(const glm::vec3& vec) {
    info() << "[vec3]: " << "(" << vec.x << ", "
                                << vec.y << ", "
                                << vec.z << ")";
}

void Logger::logVector(const glm::vec4& vec) {
    info() << "[vec4]: "
           << "("
           << vec.x << ", "
           << vec.y << ", "
...
void Logger::logMatrix(const glm::mat3& mat) {
    info() << "[mat3]:\n";
...
void Logger::logMatrix(const glm::mat4& mat) {
    info() << "[mat4]:\n";
